...
async function pesquisarProduto(q) {
  try {
    ...
    div.innerHTML = data.map(p => `
      <div class="produto-resultado" onclick="adicionarAoCarrinho(${JSON.stringify(p).replace(/"/g,'&quot;')})">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            ...
            <div class="text-muted" style="font-size:11px">${escHtml(p.categoria_nome)}</div>
          </div>
          <div class="text-end">
